...
EMAIL_SERVICE_CONFIG = {
	"Frappe Mail": {
		"use_imap": 0, "use_ssl": 0, "validate_ssl_certificate": 0, "use_starttls": 0,
		"email_server": None, "incoming_port": 0, "always_use_account_email_id_as_sender": 1,
		"use_tls": 0, "use_ssl_for_outgoing": 0, "smtp_server": None, "smtp_port": None,
		"no_smtp_authentication": 0,
	},
	"GMail": {"email_server": "imap.gmail.com", "use_ssl": 1, "smtp_server": "smtp.gmail.com"},
	"Outlook": {"email_server": "imap-mail.outlook.com", "use_ssl": 1, "smtp_server": "smtp-mail.outlook.com"},
	"Sendgrid": {"smtp_server": "smtp.sendgrid.net", "smtp_port": 587},
	"SparkPost": {"smtp_server": "smtp.sparkpostmail.com"},
	"Yahoo": {"email_server": "imap.mail.yahoo.com", "use_ssl": 1, "smtp_server": "smtp.mail.yahoo.com", "smtp_port": 587},
	"Yandex": {"email_server": "imap.yandex.com", "use_ssl": 1, "smtp_server": "smtp.yandex.com", "smtp_port": 587},
	"Custom": {},
}

SERVICES = [
	{"name": "GMail", "custom": False, "info": "Requires 2FA and an app-specific password.",
	 "link": "https://support.google.com/accounts/answer/185833"},
	{"name": "Outlook", "custom": False, "info": "Requires 2FA and an app-specific password.",
	...
	{"name": "Sendgrid", "custom": False, "info": "Use an API key as the SMTP password.",
	 "link": "https://sendgrid.com/docs/"},
	{"name": "SparkPost", "custom": False, "info": "Use your SparkPost SMTP credentials.",
	 "link": "https://support.sparkpost.com/"},
	{"name": "Yahoo", "custom": False, "info": "Requires 2FA and an app-specific password.",
	 "link": "https://help.yahoo.com/kb/SLN15241.html"},
	{"name": "Yandex", "custom": False, "info": "Requires 2FA and an app-specific password.",
	 "link": "https://yandex.com/support/id/authorization/app-passwords.html"},
	{"name": "Frappe Mail", "custom": True, "info": "Requires an API key & secret from your Frappe Mail account.",
...
def list_email_accounts():
	...
	return frappe.get_list(
		"Email Account",
		fields=["name", "email_account_name", "email_id", "service", "enable_incoming",
			"enable_outgoing", "default_incoming", "default_outgoing"],
...
def update_email_account(name: str, data=None):
	...
	for field in ("email_account_name", "enable_incoming", "enable_outgoing",
		"default_incoming", "default_outgoing"):
		if field in data:
			doc.set(field, 1 if data[field] in (1, True, "1") else 0 if field.startswith(("enable", "default")) else data[field])
